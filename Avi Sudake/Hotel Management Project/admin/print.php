...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>HOTEL FRIEND'S</p>
				<p>Kalamb Latur Road,<br>Near by Hanuman Vidhyaly,<br>Ranjni.</p>
				<p>(+91) 96 04 85 95 22</p>
			</address>
			<span><img alt="" src="assets/img/sun.jpg" width="300" height="100"></span>
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@hotelfriend's.com || Web :- www.hotelfriend's.com || Phone :- (+91) 96 04 85 95 22 </p>
			</div>
		</aside>
		<br><br><br>
		<h1><center> Thank You , Please Visit Again...🙏😍</center></h1><br><br>
	</body>
</html>
<?php
$free="Free";
